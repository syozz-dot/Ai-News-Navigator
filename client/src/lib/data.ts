 ...
 * AI 首席产品专家日报 — 今日情报数据
 * Date: 2026-02-28
 * Design: Dark Intelligence Terminal
 */

export const todayDate = "2026-02-28";
export const issueNumber = "Vol.001 · Issue #001";
...
export const papers: Paper[] = [
  {
    ...
    authors: "Jingxuan Wei, Siyuan Li, et al. (Stan Z. Li, Shuicheng Yan 团队)",
  ...
  },
  {
    ...
    authors: "Sahal Shaji Mullappilly et al. (MBZUAI)",
    submitted: "2026-02-26",
    date: "2026-02-26",
  ...
  },
  {
    ...
    authors: "Xiaoxi Li, Wenxiang Jiao, et al. (Renmin University)",
    submitted: "2026-02-26",
    date: "2026-02-26",
...
export const products: Product[] = [
  ...
  },
  {
    ...
    date: "2026-02-25",
    category: "AI Infrastructure · No-Code",
...
export const oneThingInsight = {
  date: "2026-02-28",
  headline: "OpenAI 的 1100 亿美元",
  subheadline: "不是融资新闻，是基础设施战争的开战宣言",
  content: "**OpenAI 在 AWS 上构建「有状态运行时」**。这意味着 AI Agent 将获得持久记忆，产品的底层逻辑将被重写——不是明天，但已经在路上了。现在是评估你的产品「当用户的 AI 助手记住了一切，我们的差异化还在哪里？」的最佳时机。",
  source: "综合 OpenAI 融资公告 + AWS 合作协议",
  urgency: "立即思考",
};
